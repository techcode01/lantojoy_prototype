...
import { ZegoServerResponse, ZegoSnapshotOptions, ZegoStreamUpdateType, ZegoLocalViewOptions, ZegoLocalAduioOptions, ZegoLocalStreamEvent } from "../../../../code/zh/ZegoExpressEntity.web";
...
export declare class ZegoCaptureStream {
    ...
    eventHandler: {
        ...
        canPlayAudio: (e: any) => void;
        canPlayVideo: (e: any) => void;
        canPlayCaptureVideo: (e: any) => void;
        canPlayCaptureAudio: (e: any) => void;
    };
    eventManager: EventManager;
    get view(): HTMLElement | null;
    isPlayingVideo: boolean;
    isPlayingCaptureVideo: boolean;
    get autoPlay(): boolean;
    getAudioTracks(): MediaStreamTrack[] | [];
    getVideoTracks(): MediaStreamTrack[] | [];
    getTracks(): MediaStreamTrack[] | [];
    aCaptureViewer: StreamView | null;
    vCaptureViewers: StreamView[];
    videoWrappers: HTMLElement[];
    viewer: StreamView | null;
    private _zgp_previewer;
    originVideoTrack: MediaStreamTrack | null;
    originAudioTrack: MediaStreamTrack | null;
    ...
    startPublish(): void;
    replacePublish(type?: ZegoStreamUpdateType, stream?: MediaStream): void;
    resetPublish(): void;
    ...
    createZegoStreamPreview(stream: MediaStream, onlyPreview: boolean, previewType?: "camera" | "custom" | "screen"): ZegoPreview;
