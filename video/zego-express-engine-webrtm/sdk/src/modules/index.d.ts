...
import { ZegoRoomStateChangedReason } from '../../code/zh/ZegoExpressEntity';
import { ZegoRoomServicer } from './ZegoRoomServicer';
import { ZegoRoomConfig } from '../../code/zh/ZegoExpressEntity';
export declare class LiveRoomModules {
    ...
    get liveRoomHandler(): ZegoRoomServicer;
    ...
    constructor(roomID: string, _zgp_stateCenter: StateCenter, _zgp_logger: ZegoLogger, dataReport: ZegoDataReport, rtm: ZegoExpressWebRTM, _liveRoomHandler: ZegoRoomServicer, service?: any);
    ...
    private _HBResponse;
    private _roomLoginResponse;
    checkRoomSession(roomSessionID: any): any;
    private _handleMultiRoom;
    isLogin(): boolean;
    isLogout(): boolean;
    isTryLogin(): boolean;
    isDisConnect(): any;
