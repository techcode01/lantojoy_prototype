document.addEventListener('DOMContentLoaded', function () {
  ...
  // fetch('http://127.0.0.1:5500/therapist/js/cal.json')
  // .then(response => response.json())
  // .then(data => console.log(data))
  
  var ndata;
   async function load(){
    const response = await fetch('http://127.0.0.1:5500/therapist/js/cal.json');
     ndata = await response.json();
     const myEvents = JSON.parse(localStorage.getItem('data')) || (ndata) ||
     [
      //load();
        {
          id: uuidv4(),
...
// const myEvents = JSON.parse(localStorage.getItem(data)) || 
//    [
//     //load();
//       // {
//       //   id: uuidv4(),
